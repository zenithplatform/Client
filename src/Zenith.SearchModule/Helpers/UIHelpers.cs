...
namespace Zenith.SearchModule.Helpers
{
    public static class UIHelpers
    {
        /*
        public static void ShowPopupWindow(PopupWindow popupWindow, Size windowSize, FrameworkElement positioningElement, object inputData, object dataContext)
        {
